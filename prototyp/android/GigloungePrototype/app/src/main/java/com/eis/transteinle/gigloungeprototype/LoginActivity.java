...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
     ...
     * the user.
     */
    public class UserLoginTask extends AsyncTask<List<NameValuePair>, String, JSONObject> {
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if(json != null) {
                ...
                try {
                    if(json.getString("message").equalsIgnoreCase("Login Succesful")) {
                    ...
                    } else if(json.getString("message").equalsIgnoreCase("User not found")){
                        mEmailView.setError(json.getString("message"));
                        mEmailView.requestFocus();
                    } else if(json.getString("message").equalsIgnoreCase("Invalid Password")){
