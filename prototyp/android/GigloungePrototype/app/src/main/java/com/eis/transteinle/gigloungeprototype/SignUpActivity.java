...
public class SignUpActivity extends Activity implements LoaderCallbacks<Cursor> {
     ...
     * the user.
     */
    public class UserRegisterTask extends AsyncTask<List<NameValuePair>, String, JSONObject> {
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if(json != null) {
                ...
                try {
                    if(json.getString("message").equalsIgnoreCase("User Registration succesful")) {
                    ...
                    } else if(json.getString("message").equalsIgnoreCase("User Already exists")){
